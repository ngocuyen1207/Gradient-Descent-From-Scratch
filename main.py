...
# Load the data
X_train, y_train, X_val, y_val = load_and_preprocess_data(file_path, target_column)
...
# plot_optimizer_performance(X_train, y_train, X_val, y_val, optimizers, learning_rate=0.1, num_epochs=10000, patience=100)
