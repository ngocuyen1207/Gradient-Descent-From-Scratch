...
optimizer_hyperparam = {
    "GradientDescent": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0},
    "Mini-Batch Optimizer": {"learning_rate": 0.01, "batch_size": 1, "l1_lambda": 0.01, "l2_lambda": 0.01},
    "Momentum": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0.01},
    "RMSprop": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0.01},
    "Adam": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0.01},
    "AdaGrad": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0.01},
    "AdamW": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0.01},
    "Nadam": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0.01},
    "Adadelta": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0},
    "Nesterov": {"learning_rate": 0.1, "l1_lambda": 0.01, "l2_lambda": 0.01},
}
learning_rates = [0.001, 0.01, 0.1]
batch_sizes = [1, 4, 8, 16, 32, 64]
l1_lambdas = [0.0, 0.001, 0.01, 0.1, 1, 2, 5, 10]
l2_lambdas = [0.0, 0.001, 0.01, 0.1, 1, 2, 5, 10]
