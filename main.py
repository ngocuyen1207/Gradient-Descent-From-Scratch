...
optimizer_hyperparam = {
    "GradientDescent": {"learning_rate": 0.1, "l1_lambda": 0.1, "l2_lambda": 0},
    "Mini-Batch Optimizer": {"learning_rate": 0.01, "batch_size": 1, "l1_lambda": 0, "l2_lambda": 0},
    "Momentum": {"learning_rate": 0.1, "l1_lambda": 0.0, "l2_lambda": 0.001},
    "RMSprop": {"learning_rate": 0.1, "l1_lambda": 0.0, "l2_lambda": 0.0},
    "Adam": {"learning_rate": 0.1, "l1_lambda": 1, "l2_lambda": 0},
    "AdaGrad": {"learning_rate": 0.1, "l1_lambda": 0, "l2_lambda": 0},
    "AdamW": {"learning_rate": 0.1, "l1_lambda": 5, "l2_lambda": 0},
    "Nadam": {"learning_rate": 0.1, "l1_lambda": 0.0, "l2_lambda": 0.0},
    "Adadelta": {"learning_rate": 0.1, "l1_lambda": 0, "l2_lambda": 0.01},
